#ifndef LEXGINE_CORE_PSO_XML_PARSER_H
...
*/
class PSOXMLParser : public ErrorBehavioral
{
public:
    ...
    */
    PSOXMLParser(std::string const& xml_source);
...
#define LEXGINE_CORE_PSO_XML_PARSER_H
#endif