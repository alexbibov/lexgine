    ...
    m_device{ device }
{
    ...
    #ifdef D3D12DEBUG
    root_signature->SetName(misc::ascii_string_to_wstring(getStringName() + "_root_signature").c_str());
    #endif
    ...
    m_device{ device }
{
    ...
    #ifdef D3D12DEBUG
    p_root_signature->SetName(misc::ascii_string_to_wstring(getStringName()+"_root_signature").c_str());
    #endif
...
void PipelineState::setStringName(std::string const & entity_string_name)
{
    ...
    m_pipeline_state->SetName(misc::ascii_string_to_wstring(entity_string_name).c_str());
}
